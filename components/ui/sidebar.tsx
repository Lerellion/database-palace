						...
						<div className="flex-1 overflow-y-auto p-2 space-y-6">
							<SidebarSection title="Connection">
								...
								<SidebarItem
									...
									isActive={pathname === '/database/status'}
								/>
							</SidebarSection>
							...
							<SidebarSection title="Data">
								<SidebarItem
									...
									isActive={pathname === '/database/tables'}
								/>
								<SidebarItem
									icon={<LayersIcon size={18} />}
									label="Schema"
									href="/database/schema"
									isActive={pathname === '/database/schema'}
								/>
								<SidebarItem
							...
							<SidebarSection title="Security">
								<SidebarItem
									...
									isActive={pathname === '/database/access'}
								/>
								<SidebarItem
									icon={<ShieldIcon size={18} />}
									label="Backups"
									href="/database/backups"
									isActive={pathname === '/database/backups'}
								/>
								<SidebarItem
									icon={<AlertTriangleIcon size={18} />}
									label="Logs"
									href="/database/logs"
									isActive={pathname === '/database/logs'}
								/>
							</SidebarSection>
							...
							<SidebarSection title="Settings">
								<SidebarItem
									...
									isActive={pathname === '/database/settings'}
								/>
							</SidebarSection>
						</div>
					</div>
...
function SidebarItem({ icon, label, href, isActive }: SidebarItemProps) {
	return (
		<Link href={href}>
			<Button
				variant="ghost"
				className={cn('w-full justify-start gap-2 px-2', isActive && 'bg-muted')}
			>
				{icon}
				<span>{label}</span>
			</Button>
